...
export default function Feedback() {
  ...
  return (
    <section className="mt-12 mx-4 md:mx-auto max-w-4xl">
      <div>
        <h2 className="font-bold text-xl lg:text-2xl">You did a great job!</h2>
      ...
      <div className="mt-16 rounded-lg border border-gray-300 bg-purple-100">
        <h3 className="flex items-center justify-between w-full p-4">
