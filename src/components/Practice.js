...
export default function Practice() {
  // Here for the key words and example sentence, these should be fetched from API
  const helpInfo = [
    {
      title: "Key Words",
  ...
  return (
    <section className="mt-12 mx-4 max-w-4xl md:mx-auto">
      <div>
        ...
        <div className="mt-4 max-w-lg mx-auto bg-white rounded-2xl p-4">
          <img src="/intro.png" alt="AI-Generated" className="w-full h-auto" />
        </div>
      </div>
      <div className="mt-8">
      ...
      <div className="mt-8">
        ...
        <div className="rounded-lg border border-gray-300 bg-purple-100">
